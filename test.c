...
int main() {
    ...
    char nop[] = {0x90};
	char hello[] = {0x50,0x53,0x51,0x52,
                    0x48,0xc7,0xc0,0x05,0x00,0x00,0x00,
                    0x48,0xc7,0xc3,0x43,0x07,0x40,0x00,
                    0x48,0xc7,0xc1,0x66,0x00,0x00,0x00,
                    0x48,0xc7,0xc2,0xb6,0x01,0x00,0x00,
                    0xcd,0x80,
                    0x48,0x89,0xc3,
                    0x48,0xc7,0xc0,0x04,0x00,0x00,0x00,
                    0x48,0xc7,0xc1,0x43,0x07,0x40,0x00,
                    0x48,0xc7,0xc2,0x0a,0x00,0x00,0x00,
                    0xcd,0x80,
                    0x5a,0x59,0x5b,0x58,
                    0xbd,0x30,0x04,0x40,0x00,
                    0xff,0xe5,
                    0x68,0x65,0x6c,0x6c,0x6f,0x77,
    ...
    fwrite(&hello, sizeof(hello),1,write);
    for(int i=0; i <4096 - sizeof(hello);i++)
    {
